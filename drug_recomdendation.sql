...
INSERT INTO `company` (`cid`, `cname`, `place`, `address`, `phonenum`, `email`, `password`) VALUES
(1, 'Sun pharma', 'Banglore', 'xyz plane', '9846210756', 'sun@gmail.com', '123'),
(2, 'cipla', 'cochi', '4th avenue , central squa', '7895756757', 'cipla@gmail.com', '1234'),
(3, 'lupin', 'chennai', 'qwe', '9087687787', 'lupin@gmail.com', '123'),
(5, 'Ytc', 'mumbai', 'Mumbat 2nd street', '7665567898', 'Ytc@123', '123');
...
('6pdrzj5csiebi55rvp8w3sabobi4g18v', 'eyJ1aWQiOjMsInVuYW1lIjoicHJhbmF2QGdtYWlsLmNvbSIsInVwYXNzIjoiMjMiLCJ1dHlwZSI6InVzZXIifQ:1uogLc:EYet72fIsI56EPLWfCLjXqDfCpP7QRKau-tnJ8HESmk', '2025-09-03 10:47:16'),
...
('i1zb25pri35uh3ikf2vbyu3rx2am64z1', 'eyJ1aWQiOjMsInVuYW1lIjoicHJhbmF2QGdtYWlsLmNvbSIsInVwYXNzIjoiMjMiLCJ1dHlwZSI6InVzZXIifQ:1tszPO:MEbQkbg8aVZ6SFClAI2DmwSR_kOEL3E1Ao_QLEHb4to', '2025-03-28 07:24:42'),
...
('ls8o0fdilzooyuofdfy1ld7es4ybhx93', 'eyJ1aWQiOjEsInVuYW1lIjoiam9obkBnbWFpbC5jb20iLCJ1cGFzcyI6IjEyMyIsInV0eXBlIjoiZG9jdG9yIn0:1unCU9:SsCmN9JTH9j0XnmresiJ__6vA2jtMV6g17dNUtZk4U4', '2025-08-30 08:41:57'),
('pkpd6r8zhcxxh0xz2ywg5g7c61300p3v', 'eyJ1aWQiOjEsInVuYW1lIjoic3VuQGdtYWlsLmNvbSIsInVwYXNzIjoiMTIzIiwidXR5cGUiOiJjb21wYW55In0:1unD3t:msmT3Srq-3exi-45KqKZFLtX3YxTvZxkqMTzaek_704', '2025-08-30 09:18:53'),
...
('ychqn400mn5p6xnb7b2afxr4s01abr9j', 'eyJ1aWQiOjMsInVuYW1lIjoicHJhbmF2QGdtYWlsLmNvbSIsInVwYXNzIjoiMjMiLCJ1dHlwZSI6InVzZXIifQ:1txg9a:MVSh4MVuRXuZblJI_kN8ZJyA4ssI5ApTD9JFsSbEvHA', '2025-04-10 05:51:46'),
...
INSERT INTO `doctor` (`doc_id`, `name`, `specilization`, `license`, `qualification`, `email`, `password`) VALUES
(1, 'john', 'neuro', 'N576D4', 'MBBS,MD', 'john@gmail.com', '123'),
(4, 'Manu ', 'Ortho', '45674', 'MBBSMD', 'manu@123', '123');
...
(1, 3, 'rtyrytr', '2025-08-20'),
(2, 3, 'fdv', '2025-08-20'),
(3, 4, 'yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy', '2025-08-20'),
(4, 4, 'dfdrrrrttt', '2025-08-20'),
(5, 4, 'sadfsf', '2025-08-20');
...
(9, 1, 'john@gmail.com', '123', 'doctor', 'true'),
(2, 1, 'sun@gmail.com', '123', 'company', 'true'),
(3, 3, 'pranav@gmail.com', '23', 'user', ''),
(4, 2, 'cipla@gmail.com', '1234', 'company', 'true'),
(5, 3, 'lupin@gmail.com', '123', 'company', 'true'),
(6, 4, 'aswin@gmail.com', '123', 'user', ''),
(8, 0, 'admin@gmail.com', 'admin', 'admin', ''),
(12, 4, 'manu@123', '123', 'doctor', 'true'),
(13, 5, 'Ytc@123', '123', 'company', 'true');
...
CREATE TABLE IF NOT EXISTS `med_details` (
  ...
  `cmp` varchar(25) NOT NULL,
  `effects` varchar(25) NOT NULL,
  `pres` varchar(25) NOT NULL,
...
INSERT INTO `med_details` (`med_id`, `name`, `used`, `mg`, `dosage`, `cmp`, `effects`, `pres`, `pack`, `image`) VALUES
(6, 'Okacet', 'runny nose, sneezing, and', '10', '1', 'cetrizine', 'sleepiness', 'Non prescription', '11`', 'media/med1.png'),
(5, 'paracetamol', 'headache', '500', '1', 'paracetamol', 'skin rashes, breathing pr', 'Non prescription', '15', 'media/med.png'),
(7, 'dolo', 'vomiting', '10', '2', 'ghchg', 'sleeping', 'piuuu', '11', 'media/images_3_gr2eV4z.jpg'),
(8, 'Evion', 'vitamine D', '10', '2', 'ghchg', 'sleeping', 'non', '11', 'media/images.jpg');
...
INSERT INTO `pword` (`pid`, `pword`) VALUES
(1, 'good'),
(2, 'good'),
(3, 'good'),
(4, 'good');
...
INSERT INTO `review` (`rid`, `uid`, `med_id`, `date`, `review`, `rating`) VALUES
(1, 4, 5, '2024-04-18', 'effective medicine, good one', 4),
(2, 4, 6, '2024-04-18', 'good and effective and works fine', 4),
(3, 4, 5, '2025-08-20', 'good', 3),
(4, 4, 8, '2025-08-20', 'goods', 3);
...
INSERT INTO `rtemp` (`uid`, `bkid`) VALUES
(2, 5),
(2, 3),
(2, 4),
(2, 2),
...
INSERT INTO `user` (`uid`, `uname`, `age`, `gender`, `place`, `address`, `phonenum`, `email`, `password`) VALUES
(3, 'pranav', '24', 'Male', 'dfdd', 'qwerty', '897756576', 'pranav@gmail.com', '23'),
(4, 'aswin', '24', 'Male', 'adoor', 'abcd', '9067876452', 'aswin@gmail.com', '123');
